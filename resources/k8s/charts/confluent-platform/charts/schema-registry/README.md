...
### Install with a existing kafka release

```console
helm install --set kafka.bootstrapServers="PLAINTEXT://unhinged-robin-kafka-headless:9092" cp-helm-charts/charts/schema-registry
```
...
lolling-chinchilla-schema-registry  1        1        1           0          1s

==> v1/Pod(related)
NAME                                                    READY  STATUS             RESTARTS  AGE
lolling-chinchilla-schema-registry-58f854bd47-jxrcj  0/1    ContainerCreating  0         1s

==> v1/Service
NAME                                   TYPE       CLUSTER-IP    EXTERNAL-IP  PORT(S)   AGE
lolling-chinchilla-schema-registry  ClusterIP  10.19.245.11  <none>       8081/TCP  1s

==> v1/ConfigMap
NAME                                               DATA  AGE
lolling-chinchilla-schema-registry-jmx-configmap  1     1s
```

There are
1. A [Deployment](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/) `lolling-chinchilla-schema-registry` which contains 1 Schema Registry [Pod](https://kubernetes.io/docs/concepts/workloads/pods/pod-overview/): `lolling-chinchilla-schema-registry-58f854bd47-jxrcj`.
1. A [Service](https://kubernetes.io/docs/concepts/services-networking/service/) `lolling-chinchilla-schema-registry` for clients to connect to Schema Registry.
...
```console
helm install --name my-schema-registry -f my-values.yaml ./schema-registry
```
...
The configuration parameters in this section control the resources requested and utilized by the schema-registry chart.
...
| Parameter | Description | Default |
| --------- | ----------- | ------- |
| `image` | Docker Image of Confluent Schema Registry. | `confluentinc/schema-registry` |
