...
```console
helm install --set zookeeper.url="unhinged-robin-zookeeper:2181",schema-registry.url="http://lolling-chinchilla-schema-registry:8081" cp-helm-charts/charts/ksql-server
```
...
excited-lynx-ksql-server  ClusterIP  10.31.253.70  <none>       8088/TCP  10s

==> v1beta2/Deployment
NAME                         DESIRED  CURRENT  UP-TO-DATE  AVAILABLE  AGE
excited-lynx-ksql-server  1        1        1           0          10s

==> v1/Pod(related)
NAME                                         READY  STATUS  RESTARTS  AGE
excited-lynx-ksql-server-d4848ff94-x5fmn  2/2    Running   1         10s

==> v1/ConfigMap
NAME                                                DATA  AGE
excited-lynx-ksql-server-jmx-configmap           1     10s
excited-lynx-ksql-server-ksql-queries-configmap  1     10s
...
There are
1. A [Deployment](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/) `excited-lynx-ksql-server` which contains 1 KSQL Server instance [Pod](https://kubernetes.io/docs/concepts/workloads/pods/pod-overview/): `excited-lynx-ksql-server-d4848ff94-x5fmn`.
1. A [Service](https://kubernetes.io/docs/concepts/services-networking/service/) `excited-lynx-ksql-server` for clients to connect to KSQL Server.
...
The configuration parameters in this section control the resources requested and utilized by the ksql-server chart.
...
| Parameter | Description | Default |
| --------- | ----------- | ------- |
| `image` | Docker Image of Confluent KSQL Server. | `confluentinc/ksql-server` |
